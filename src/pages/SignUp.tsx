...
const SignUp = () => {
  ...
  const submitForm = (type: string) => {
    ...
    if (names.length < 2)
      return showToast({
        message: "Veillez compléter tous les champs et mettre 2 noms séparés par un espace",
        typeToast: "dark"
      });
        ...
        <div className='content-form'>
          ...
          <div className='content-fields'>
            ...
            <div className='content-actions  margin-2'>
              <Button
                textBtn='Créer un compte admin'
                // display='block'
                styleBtn={"btnPrimary"}
                actionTo={() => submitForm("ADMIN")}
              />
              <Button
                textBtn='Créer un compte client'
                // display='block'
                styleBtn={"btnPrimary"}
