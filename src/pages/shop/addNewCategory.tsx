...
const AddNewCategory = () => {
  ...
  const createCategory = async () => {
    if (
      ...
      return showToast({
        message: "Veiller completer tous les champs svp !",
        typeToast: "error"
      });
    }
    try {
        ...
        <div className='content-form'>
          <div className='content-groupLoginwith '>
            <div className='content-body'>
              <h4>Création de nouvelles categories </h4>
              <p>Ces informations décriront la categorie </p>
            </div>
          </div>
